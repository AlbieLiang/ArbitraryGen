...
[![Release Version](https://img.shields.io/badge/release-2.1.6-red.svg)](https://github.com/AlbieLiang/ArbitraryGen/releases)
[![wiki](https://img.shields.io/badge/wiki-2.1.6-red.svg)](https://github.com/AlbieLiang/ArbitraryGen/wiki) 
...
目前AG已经更新到v2.1.6版本，项目仍在开发中，欢迎一起完善这个项目。
...
buildscript {
    ...
    dependencies {
        ...
        classpath 'cc.suitalk.tools:arbitrarygen-plugin:<last-version>'
    }
}
allprojects {
    repositories {
